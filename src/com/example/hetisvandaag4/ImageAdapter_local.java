...
public class ImageAdapter_local extends BaseAdapter
{
	...
	public ImageAdapter_local(Context c, int pagemarker)
	{
	...
	public void loadDrawables(Class<?> clz)
	{
		...
		for (Field field : fields)
		{
			...
			StringBuilder resourcenamesb = new StringBuilder(resourcename);
			resourcename = resourcenamesb.delete(0, resourcenamesb.indexOf("/")+1).toString();
			String marker = null;
			try
			{
				marker = resourcename.substring(0,9);
